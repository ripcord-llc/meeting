...
function createShadow(color: string) {
  ...
  return {
    ...
    purple: `0 8px 16px 0 ${alpha(themeColor.purple.main, 0.24)}`,
    cyan: `0 8px 16px 0 ${alpha(themeColor.cyan.main, 0.24)}`,
    orange: `0 8px 16px 0 ${alpha(themeColor.orange.main, 0.24)}`,
    //
